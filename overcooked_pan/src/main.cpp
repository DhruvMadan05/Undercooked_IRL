...
//   GND          -> GND
//   SW (button)  -> GPIO14  (same pin cutting board uses for its switch, on this
//                            board it is free; internal pull-up, no resistor needed)
...
#define JOY_X_PIN   34
#define JOY_Y_PIN   35
#define JOY_CLICK_PIN 14
#define JOY_DEAD_ZONE 0.6f // how far to push (0-1) before it counts as a direction
#define INVERT_X    false
#define INVERT_Y    false

JoystickPatternTask joystickTask(JOY_X_PIN, JOY_Y_PIN, JOY_CLICK_PIN, JOY_DEAD_ZONE, INVERT_X, INVERT_Y);
